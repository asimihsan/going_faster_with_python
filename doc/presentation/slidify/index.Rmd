...
-   CFFI with non-JIT `pcre` is $\frac{11.7-17.3}{17.3} \approx 32\%$ faster than the Cython version.
-   CFFI with JIT `pcre` is $\frac{7.2-17.3}{17.3} \approx 58\%$ faster than the Cython version.
